...
RSpec.describe Api::V1::PlayersController, type: :controller do
  ...
  describe 'GET #statistics' do
    ...
    let(:service_klass) { StatisticsGenerators::PlayerStatisticsService }

    it 'returns a success response' do
      expect(service_klass).to receive(:new).with(player).and_return(service_klass.new(player))
      get :statistics, params: { id: player.id }
    end
  end
